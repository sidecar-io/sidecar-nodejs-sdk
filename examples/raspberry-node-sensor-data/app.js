...
// User access keys
var userKeyId = configuration.userKeys.userKeyId;
var userSecret = configuration.userKeys.userSecret;

// User Device ID
var deviceId = configuration.userKeys.deviceId;


setInterval(function() {
  sendSensorData();
},1000); //Set Sample Rate to Publish Events to Sidecar
